...
#include <unistd.h>
void setColor(unsigned short ForeColor, unsigned short BackGroundColor) {
	if (BackGroundColor == 0xA)
		printf("\033[0;37;42m");
	else if (BackGroundColor == 0xC)
		printf("\033[0;37;41m");
}
void resetColor() {
	printf("\e[0;37;40m");
...
int main() {
	...
	printf("Your accepted radio is %lf%% (%d / %d).\r\n",
	       ...
	       n);
	if (n == 1)
		puts("The wrong problem has been saved to wrong.txt");
	else
		puts("All your wrong problems have been saved to wrong.txt");
#ifdef OS_WINDOWS
	endwin();
#endif
	return 0;
